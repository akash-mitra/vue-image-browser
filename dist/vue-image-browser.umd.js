                ...
                methods: {
                        ...
                        uploadFiles: function () {
                                ...
                                var loop = function ( i ) {
                                        ...
                                        var header_keys = Object.keys(p.requestHeaders);
                                        for (var i$1=0; i$1 < header_keys.length; i$1++) {
                                                var header = header_keys[i$1];
                                                var val = p.requestHeaders[header];
